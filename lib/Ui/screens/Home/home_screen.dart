...
import 'package:eClassify/Utils/DeepLink/nativeDeepLinkManager.dart';
...
class HomeScreenState extends State<HomeScreen>
  ...
  void openAppLink(Uri uri) {
    ...
    //Constant.navigatorKey.currentState?.pushNamed(Routes.onGenerateRouted(''));
    /* Navigator.push(
      Constant.navigatorKey.currentContext!,
      NativeLinkWidget.render(
  ...
  void nativeLinkSettings() async {
    ...
    if (appLink == null || !(appLink.toString().contains('/items-details/'))) {
      return;
    }
    openAppLink(appLink);
