                      ...
                      child: Row(
                        children: [
                          GestureDetector(
                            ...
                            child: SvgPicture.asset(AppIcons.homeDark),
                          ),
                            ...
                            itemBuilder: (context, index) {
                              CategoryModel category =
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    if (widget.current.children[index]
                                            .children.isEmpty &&
                                        widget.current.children[index]
                                                .subcategoriesCount ==
                                            0) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        if (state.categories[index].children.isEmpty &&
                            state.categories[index].subcategoriesCount ==
                                0) {
                          screenStack++;
