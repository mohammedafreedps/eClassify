...
import '../../../data/cubits/item/fetch_item_from_category_cubit.dart';
...
class ItemsList extends StatefulWidget {
  ...
  const ItemsList({super.key, this.categoryId, this.categoryName});
    ...
    return InkWell(
      ...
      onTap: () {
        Navigator.pushNamed(context, Routes.filterScreen,
            arguments: {"update": getFilterValue,"from":"itemsList"}).then((value) {
          if (value == true) {
            ItemFilterModel updatedFilter = filter!.copyWith(categoryId: widget.categoryId!);
            context.read<FetchItemFromCategoryCubit>().fetchItemFromCategory(
                categoryId: int.parse(
                  widget.categoryId!,
                ),
