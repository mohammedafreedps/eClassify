...
/*  Widget createFeaturesAds() {
  ...
  void safetyTipsBottomSheet() {
    tipsList = context.read<FetchSafetyTipsListCubit>().getList() ?? [];
    if (tipsList!.isEmpty) {
      makeOfferBottomSheet(model);
      return;
    }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                ).bold(weight: FontWeight.w600).size(context.font.larger),
              ),
              ListView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    return checkmarkPoint(
                        context, tipsList![index].description!);
                  }),
              SizedBox(
                height: 13,
              ),
              Padding(
                ...
                child: _buildButton("continueToOffer".translate(context), () {
                  Navigator.pop(context);
                  makeOfferBottomSheet(model);
                }, context.color.territoryColor, context.color.secondaryColor),
              ),
              //SizedBox(height: 15 ,)
            ],
          ),
