    ...
    try {
      ...
      if (forceRefresh == true) {
        ...
        /*  Constant.googlePlaceAPIkey = RSAEncryption().decrypt(
         ...
         Constant.googlePlaceAPIkey = settings['data']['place_api_key'];
        /*Constant.googlePlaceAPIkey =
            HelperUtils.decryptString(settings['data']['place_api_key']);*/
         ...
         /* Constant.googlePlaceAPIkey =
          ...
          await CheckInternet.check(
            ...
            onNoInternet: () {
              ...
              Constant.googlePlaceAPIkey = (state as FetchSystemSettingsSuccess)
                      .settings['data']?['place_api_key'] ??
                  "";
              /*Constant.googlePlaceAPIkey = HelperUtils.decryptString(
