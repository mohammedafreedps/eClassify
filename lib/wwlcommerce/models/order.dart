class Order {
  ...
  late final String orderAddress;
...
class OrderItem {
  ...
  late final String returnRequested;
  late final String returnRrason;
  ...
  OrderItem.fromJson(Map<String, dynamic> json) {
    ...
    returnRrason = json['return_reason'].toString();
  }
}
