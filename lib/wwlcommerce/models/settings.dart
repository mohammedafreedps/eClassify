...
class SettingsData {
  ...
  SettingsData.fromJson(Map<String, dynamic> json) {
    ...
    webSettings = json['web_settings'] != null
        ? new WebSettings.fromJson(json['web_settings'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.webSettings != null) {
      data['web_settings'] = this.webSettings!.toJson();
    }
    return data;
  }
}
...
class WebSettings {
  ...
  WebSettings.fromJson(Map<String, dynamic> json) {
    siteTitle = json['site_title'].toString();
    websiteUrl = json['website_url'].toString();
    color = json['color'].toString();
    lightColor = json['light_color'].toString();
    darkColor = json['dark_color'].toString();
    appTitle = json['app_title'].toString();
    appTagline = json['app_tagline'].toString();
    appShortDescription = json['app_short_description'].toString();
    isAndroidApp = json['is_android_app'].toString();
    androidAppUrl = json['android_app_url'].toString();
    playStoreLogo = json['play_store_logo'].toString();
    isIosApp = json['is_ios_app'].toString();
    iosAppUrl = json['ios_app_url'].toString();
    iosStoreLogo = json['ios_store_logo'].toString();
    copyrightDetails = json['copyright_details'].toString();
    commonMetaKeywords = json['common_meta_keywords'].toString();
    commonMetaDescription = json['common_meta_description'].toString();
    showColorPickerInWebsite = json['show_color_picker_in_website'].toString();
    favicon = json['favicon'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['app_tagline'] = this.appTagline;
    data['app_short_description'] = this.appShortDescription;
    data['is_android_app'] = this.isAndroidApp;
    data['android_app_url'] = this.androidAppUrl;
    data['play_store_logo'] = this.playStoreLogo;
    data['is_ios_app'] = this.isIosApp;
    data['ios_app_url'] = this.iosAppUrl;
    data['ios_store_logo'] = this.iosStoreLogo;
    data['copyright_details'] = this.copyrightDetails;
    data['common_meta_keywords'] = this.commonMetaKeywords;
    data['common_meta_description'] = this.commonMetaDescription;
    data['show_color_picker_in_website'] = this.showColorPickerInWebsite;
    data['favicon'] = this.favicon;
