...
import 'package:eClassify/wwlcommerce/models/walletHistory.dart';
...
// _scrollController fetches the next paginated data when the current position of the user on the screen has surpassed
  ...
  void initState() {
    Future.delayed(Duration.zero).then((value) {
      context
          .read<WalletHistoryProvider>()
          .getWalletHistoryProvider(params: {}, context: context);
    });
    ...
    return Scaffold(
      ...
      body: setRefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: Consumer<WalletHistoryProvider>(
  ...
  getWalletHistoryItemWidget(WalletHistoryData walletHistory) {
    ...
    if (walletHistory.orderId == "null" &&
      ...
      print(
          ">>>>>>>>>>>> ${walletHistory.measurement.toString()}, ${walletHistory.measurementUnit.toString()}, ${walletHistory.productName.toString()}, ${walletHistory.orderId.toString()}");
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Widgets.getSizedBox(width: Constant.size5),
              Container(
          ...
          Widgets.getDivider(height: 1, color: ColorsRes.grey, thickness: 0),
          Widgets.getSizedBox(height: Constant.size5),
          CustomTextLabel(
            jsonKey: "message",
            style: TextStyle(
