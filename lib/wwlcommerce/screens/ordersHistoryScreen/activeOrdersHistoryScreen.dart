          ...
          children: [
            Column(
              ...
              children: [
                ...
                Widgets.getDivider(indent: 0, endIndent: 0),
                CustomTextLabel(
                  text: "${getTranslatedValue(
                    context,
                    "placed_order_on",
        ...
        if (provider.activeOrdersState == ActiveOrdersState.error) {
          return Container(
            ...
            child: DefaultBlankItemMessageScreen(
              ...
              title: getTranslatedValue(context, "something_went_wrong_message_title"),
              description: getTranslatedValue(context, "something_went_wrong_message_description"),
